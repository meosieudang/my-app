...
export const CBVNLuckyDraw2024 = ({
  ...
  const _loadGifts = campaignId => {
    ...
    let giftCode = params.get("giftCode");
    axios.get("/api/luckywheel/get_luckywheels", {
      params: {
        orderCode: giftCode,
  ...
  const onDrawDone = async () => axios.get("api/sellout/get_selloutgift", {
    params: {
      orderCode: giftCode,
      campaignId: campaignId,
      channelId: params.get("channelId") == "null" ? null : params.get("channelId") - 0,
      provinceId: params.get("provinceId") == "null" ? null : params.get("provinceId") - 0
    }
  }).then(({
    data: res
  }) => {
  ...
  const onLoadNoofWheel = (campaignId, orderCode) => {
    axios.get("api/luckywheel/get_luckywheel_noofwheel", {
      params: {
        orderCode: orderCode,
        campaignId: campaignId
      }
  ...
  const onGetResult = async orderCode => {
    let provinceId = params.get("provinceId");
    let channelId = params.get("channelId");
    return axios.get("/api/luckywheel/wheel_spin", {
      params: {
        orderCode,
        campaignId: campaignId,
        provinceId: provinceId == "null" ? null : provinceId - 0,
